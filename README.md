...
1. [Install Node LTS](https://nodejs.org/en/download/) (v14.9.X), which will also install NPM (you should be able to execute `node --version` and `npm --version` on the command line).
